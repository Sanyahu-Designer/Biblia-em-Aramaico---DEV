...
JAZZMIN_SETTINGS = {
    "site_title": "Evangelhos Aramaico Siriaco",
    "site_header": "Evangelhos Aramaico Siriaco",
    "site_brand": "Evangelhos Aramaico Siriaco",
    "welcome_sign": "Bem-vindo à Administração de Evangelhos Aramaico Siriaco",
    "copyright": "Evangelhos Aramaico Siriaco",
    "search_model": ["bible_app.Book", "bible_app.Chapter", "bible_app.Verse"],
    "topmenu_links": [
        {"name": "Home", "url": "admin:index", "permissions": ["auth.view_user"]},
        {"name": "Cache", "url": "admin_cache_dashboard"},
    ],
    "show_sidebar": True,
    "navigation_expanded": True,
    "hide_apps": [],
    "hide_models": [],
    "order_with_respect_to": ["auth", "bible_app"],
    "custom_links": {},
    "icons": {
